        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-50 to-green-50">
            <div className="bg-white rounded-lg shadow-xl p-8 max-w-md w-full text-center">
                ...
                <p className="text-gray-600 mb-6">
                    Thank you for submitting your investor application. We have
                    received your information and it is now under review.
                </p>

                <p className="text-gray-600 mb-8">
                    Our team will review your application and get back to you
                    within 5-7 business days. You will receive an email
                    notification once your application status is updated.
                </p>
